...
| 04 — Clarify and review | Every produced Draft Claim requires an explicit Accept or Reject decision; model output cannot assign Confirmed certainty | Clarification answer and second extraction; correction/unresolved/manual-entry flows; evidence entries; full transactional activation and recovery cases | Remains `blocked`; not complete |
